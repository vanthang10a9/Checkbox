...
$wp_customize->add_setting( 'zigcy_lite_breadcrumb_delimeter', array(
    'default' => '/',
    'sanitize_callback' => 'sanitize_text_field',
  ) );
...
$wp_customize->add_control( 'zigcy_lite_breadcrumb_delimeter',  array(
  'type'      => 'text',                    
  'label'     => esc_html__( 'Delimitor', 'zigcy-lite' ),
  'section'   => 'header_image',
) ); 
